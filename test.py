...
parser.add_argument('-opt', type=str, default='/home/ubuntu/CWNet/options/test/LSRW-nikon.yml', help='Path to options YMAL file.')
...
def main():
    ...
    save_folder = '.nikon/{}'.format(opt['name'])
